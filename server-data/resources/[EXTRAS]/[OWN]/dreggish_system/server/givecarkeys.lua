...
ESX.RegisterCommand('givecarkeys', 'user', function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx_givecarkeys:keys')

end, true, {help = "Gebe deine Autoschlüssel weiter", validate = false})
